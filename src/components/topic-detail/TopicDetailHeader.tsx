...
export const TopicDetailHeader: React.FC<TopicDetailHeaderProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-stone-900 border-b border-stone-200 dark:border-stone-800 px-4 sm:px-8 py-2 sm:py-2.5 shrink-0 flex items-center justify-between gap-3 min-h-[52px] sm:min-h-[56px] transition-colors">
      ...
      <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
        ...
        <div className="min-w-0 max-w-[140px] sm:max-w-xs lg:max-w-sm flex items-center gap-1.5 shrink">
          {isEditingTitle ? (
        ...
        <div className="shrink-0 min-w-0 max-w-[200px] sm:max-w-xs lg:max-w-md">
          {topic.next_action ? (
            <button
              ...
              className={`group inline-flex items-center gap-1.5 px-3 py-1 sm:py-1.5 rounded-xl text-xs sm:text-[13px] font-bold transition-all cursor-pointer border shadow-2xs hover:scale-[1.02] active:scale-[0.98] max-w-full truncate ${
                warning
            ...
            >
              ...
              {warning && (
                <span className="text-[10px] sm:text-[11px] font-bold text-amber-800 dark:text-amber-300 bg-amber-200/80 dark:bg-amber-900/80 px-1.5 py-0.2 sm:py-0.5 rounded shrink-0">
                  {warning}
                </span>
              )}
              <span
                className={`text-[10px] sm:text-[11px] font-mono font-bold px-1.5 py-0.2 sm:py-0.5 rounded shrink-0 ${
                  warning
