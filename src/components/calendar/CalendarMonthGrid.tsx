...
function MonthCellDroppable({
  ...
  return (
    <div
      ...
      className={`min-h-[110px] sm:min-h-[125px] flex flex-col p-1.5 sm:p-2 border-b border-r border-stone-200/70 dark:border-stone-800 transition-colors relative group select-none ${
        cell.isCurrentMonth
...
export const CalendarMonthGrid: React.FC<CalendarMonthGridProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-white dark:bg-stone-900 rounded-2xl border border-stone-200/70 dark:border-stone-800 shadow-2xs overflow-hidden">
      ...
      {/* Grid of days */}
      <div className="flex-1 grid grid-cols-7 auto-rows-fr overflow-y-auto min-w-0">
        {days.map((cell) => {
