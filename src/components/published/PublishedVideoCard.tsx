        ...
        <div className="pt-2 border-t border-stone-100 dark:border-stone-800 flex items-center justify-between text-[11px] text-stone-400 dark:text-stone-500">
          ...
          {video.notes && (
            <div className="relative group/note flex items-center cursor-help mx-1 min-w-0">
              ...
              {/* Tooltip on hover */}
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 hidden group-hover/note:block w-56 sm:w-64 p-2.5 bg-stone-900/95 dark:bg-stone-800 text-stone-100 text-xs rounded-xl shadow-xl z-30 pointer-events-none whitespace-normal leading-relaxed border border-stone-700">
